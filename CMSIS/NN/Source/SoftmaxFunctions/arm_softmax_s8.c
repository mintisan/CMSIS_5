...
#ifdef ARM_MATH_MVEI
int32x4_t arm_nn_exp_on_negative_values_32x4(int32x4_t val)
{
...
#define ACT_MAX (127)
    ...
    for (int i_num_rows = 0; i_num_rows < num_rows; ++i_num_rows)
    {
        ...
        while (vec_count)
        {
            ...
            res = arm_nn_exp_on_negative_values_32x4(res);
        ...
        while (vec_count)
        {
            ...
            tmp_res = arm_nn_exp_on_negative_values_32x4(tmp_res);
